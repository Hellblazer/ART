package com.hellblazer.art.gpu.test;
...
/**
 * Abstract base class for all LWJGL headless tests in the ART project.
 * Provides platform detection, native library management, and graceful failure handling.
 * 
 * This class follows Java 24 patterns and integrates with JUnit 5 lifecycle.
 */
public abstract class LWJGLHeadlessTest {
