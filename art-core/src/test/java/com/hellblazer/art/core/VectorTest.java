...
/**
 * Test suite for Vector interface and implementations.
 * Tests all fundamental vector operations required for ART algorithms.
 */
class VectorTest {
    ...
    void testL1Norm() {
        var vector = Vector.of(3.0, -4.0, 0.0, 5.0);
    ...
    void testL2Norm() {
        var vector = Vector.of(3.0, 4.0, 0.0);
    ...
    void testNormalization() {
        var vector = Vector.of(2.0, 4.0, 6.0);
    ...
    void testMin() {
        var a = Vector.of(0.8, 0.3, 0.9);
        var b = Vector.of(0.6, 0.7, 0.2);
    ...
    void testScale() {
        var vector = Vector.of(2.0, -3.0, 4.0);
    ...
    void testIndexBounds() {
        var vector = Vector.of(1.0, 2.0, 3.0);
    ...
    void testNullData() {
        assertThrows(NullPointerException.class, () -> Vector.of((double[]) null));
    }
    
    @Test
    @DisplayName("Empty vector handling")
    void testEmptyVector() {
        assertThrows(IllegalArgumentException.class, () -> Vector.of(new double[0]));
    }
    ...
    void testVectorImmutability() {
        ...
        var vector = Vector.of(originalData);
    ...
    void testDimensionMismatch() {
        var a = Vector.of(1.0, 2.0);
        var b = Vector.of(1.0, 2.0, 3.0);
    ...
    void testEqualityAndHashCode() {
        var a = Vector.of(1.0, 2.0, 3.0);
        var b = Vector.of(1.0, 2.0, 3.0);
        var c = Vector.of(1.0, 2.0, 4.0);
