...
# This script demonstrates the complete pipeline with metrics

echo "========================================="
echo "ART Text Generation - Integration Test"
echo "========================================="
echo ""

cd /Users/hal.hildebrand/git/ART/text-generation

# Step 1: Compile with new components
echo "Step 1: Compiling project with new components..."
mvn clean compile
if [ $? -ne 0 ]; then
...
echo "Step 2: Creating integration test..."
cat > src/main/java/com/art/textgen/IntegrationTest.java << 'EOF'
...
echo "Step 3: Compiling integration test..."
mvn compile
if [ $? -ne 0 ]; then
...
echo ""
mvn exec:java -Dexec.mainClass="com.art.textgen.IntegrationTest" -Dexec.classpathScope="compile"
...
echo "  ✅ IncrementalTrainer - Trains without forgetting"
echo "  ✅ TextGenerationMetrics - Evaluates text quality"
echo "  ✅ ExperimentRunner - Compares generation strategies"
echo ""
echo "To continue development:"
echo "  1. Expand corpus: ./expand-corpus.sh"
echo "  2. Run main app: mvn exec:java -Dexec.mainClass=\"com.art.textgen.ARTTextGenerationApp\""
echo "  3. Review progress: cat PROGRESS_REPORT.md"
echo ""
