 ...
 * batch.applyDrivingStrength(params.drivingStrength());
...
public class Layer4SIMDBatch {
     ...
     */
    public static Pattern[] processBatchSIMD(
            Pattern[] inputs,
        ...
        batch.applyDrivingStrength(drivingStrength);
        ...
        var shuntingParams = com.hellblazer.art.cortical.dynamics.ShuntingParameters.builder(size)
            ...
            .inhibitoryStrength(lateralInhibition)
            .build();

        batch.applyDynamicsExact(Math.min(timeConstant / 1000.0, 0.01), shuntingParams);
