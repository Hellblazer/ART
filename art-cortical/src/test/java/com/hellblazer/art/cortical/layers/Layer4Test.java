 ...
 * <ul>
 *   <li>Strong driving signals that can fire cells</li>
 *   <li>Fast time constants (10-50ms)</li>
 *   <li>Simple feedforward processing</li>
 *   <li>Minimal lateral inhibition initially</li>
 *   <li>Integration with shunting dynamics</li>
 * </ul>
 *
...
class Layer4Test {
    ...
    @BeforeEach
    void setUp() {
        layer4 = new Layer4("L4", LAYER_SIZE);
    ...
    void testBasicActivationWithDrivingInput() {
        ...
        for (var i = 0; i < LAYER_SIZE; i++) {
            ...
            assertTrue(output.get(i) <= parameters.ceiling(),
    ...
    void testActivationBoundsChecking() {
        ...
        for (var i = 0; i < LAYER_SIZE; i++) {
            assertTrue(output.get(i) >= parameters.floor(),
    ...
    void testPerformanceBenchmark() {
        ...
        var avgTimeMs = (endTime - startTime) / (iterations * 1_000_000.0);
    ...
    void testBackwardCompatibility() {
        ...
        assertEquals(LayerType.LAYER_4, layer4.getType(), "Type should be LAYER_4");
        ...
        layer4.addActivationListener((layerId, oldActivation, newActivation) -> {
    ...
    private Pattern createSparseInput(int activeCount) {
        ...
        for (var i = 0; i < activeCount; i++) {
            var idx = (int)(Math.random() * LAYER_SIZE);
    ...
    private double averageActivation(Pattern pattern) {
        var sum = 0.0;
        for (var i = 0; i < pattern.dimension(); i++) {
            sum += pattern.get(i);
        }
